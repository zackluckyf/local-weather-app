$(document).ready(function(){
    ...
    function showPosition(position) {
        ...
        $.get( "http://api.openweathermap.org/data/2.5/weather?lat=" + position.coords.latitude + "&lon=" + position.coords.longitude + "&cnt=1&appid=6b766b599bfc44b9f27b4f348f6ce770&units=imperial", function( data ) {
    ...
    temperature.click(function(){
        if(metric === true){
            metric = false;
            $.get( "http://api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&appid=6b766b599bfc44b9f27b4f348f6ce770&units=metric", function( data ) {
                temp = Math.round(data.main.temp);
            ...
            metric = true;
            $.get( "http://api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&appid=6b766b599bfc44b9f27b4f348f6ce770&units=imperial", function( data ) {
                temp = Math.round(data.main.temp);
                temperature.html(temp + "&deg; F");
                }, "json" );    
        }
